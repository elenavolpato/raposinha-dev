      ...
      <div class="flex flex-col md:flex-row max-w-[1200px] items-start my-8 ">
        ...
        <div class="max-w-50% mx-4">
          ...
          <p class="text-base text-gray-50 pb-2">
            Born and raised Brazilian, living in
            Piemonte, Italy (yes, I traded caipirinhas and samba for wine and
            truffles, and honestly, no regrets).
          </p>

          <p class="text-base text-gray-50 py-2">
            As if moving to another country wasn’t enough, I also changed my career in 2020 from event and presentations project manager  - so I’m fluent in reading clients minds too - to front-end developer, which basically means that now I make buttons that actually do stuff and then secretly judge the shade of blue chosen by the client.
          </p>
          ...
          <p class="text-base text-gray-50 py-2">
            What really drives me? <strong>Creative problem solving.</strong> I really enjoy untangling messy code and designing designing things that just work, and sometimes I even live spending hours debugging and making my hair turn gray.
          </p>
          {/* <p class="text-base text-gray-50 py-2">
